...
#
# 金士顿ssd 128G VS raid10 普通SATA 3.5 寸硬盘 2T (不带电池)
# warehourse 100 -c 128 -r 600 -l 1800
...
do
    ...
    #并发128 热身10分钟 跑30分钟
    #./tpcc_start -h localhost -d tpcc$bp -u root -p "" -w $bp -c 128 -r 600 -l 1800 > tpcc.w100-raid10.out
    ./tpcc_start -h localhost -d tpcc$bp -u root -p "" -w $bp -c 128 -r 600 -l 1800 > tpcc.w100-raid10-2.out
