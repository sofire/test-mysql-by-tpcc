...
set title "Mysql-5.6.25-73.1 W100 Raid10 Buffer Pool 1G~20G 并发128 持续30分" 
...
#set format y "%.2f"
#计算每秒的次数
plot datafile using 3:(\$1/$n) title "raid10 1G" with lines, \
    datafile using 6:(\$4/$n) title "raid10 2G" with lines, \
    datafile using 9:(\$7/$n) title "raid10 4G" with lines, \
    datafile using 12:(\$10/$n) title "raid10 8G" with lines, \
    datafile using 15:(\$13/$n) title "raid10 16G" with lines, \
    datafile using 18:(\$16/$n) title "raid10 20G" with lines
