...
plot datafile using 3:(\$1/$n) title "SSD poolsize=1G" with lines, \
    datafile using 6:(\$4/$n) title "SSD poolsize=2G" with lines, \
    datafile using 9:(\$7/$n) title "SSD poolsize=4G" with lines, \
    datafile using 12:(\$10/$n) title "SSD poolsize=8G" with lines, \
    datafile using 15:(\$13/$n) title "SSD poolsize=16G" with lines, \
    datafile using 18:(\$16/$n) title "SSD poolsize=20G" with lines
